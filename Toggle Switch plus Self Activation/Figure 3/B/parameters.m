...
opt=contset(opt,'MaxNumPoints',30000);
...
gammaA=1.1;  gammaB=0.1;  %Degradation rate
gA=5;          gB=5;  %Production rate


% B0=5;  lB0A=0.2;   nB0A=10; 

A0B=120; B0A=120; A0A=80 ; B0B=80; %Threshold
lB0A=0.1; lA0B=0.1 ; lA0A=5; lB0B=5;%Fold change
nB0A=1; nA0B=1; nA0A=4; nB0B=4; %Hill's coefficient
