...
x, y = np.loadtxt('TS_regimeII_BS1_lambda_1D.dat', unpack=True, usecols=[0,1])
...
x, y = np.loadtxt('TS_regimeII_BS1_lambda_1D.dat', unpack=True, usecols=[0,2])

plt.plot(x, y, color='blue', linestyle='solid', linewidth = 4, marker='o', markerfacecolor='blue', markeredgecolor="navy", markersize=12)

x, y = np.loadtxt('TS_regimeII_BS1_lambda_2D.dat', unpack=True, usecols=[0,1])
...
plt.text(10.2, -0.54, '$\lambda_p$', color='blue')
plt.text(10.2, -0.64, '$\lambda_p$', color='brown')
plt.text(10.2, -0.68, "$\lambda_m$", color='blue')
plt.text(10.2, -0.775, '$\lambda_m$', color='brown')


plt.savefig('TS_regimeII_BS1_lambda.png', dpi=300)
