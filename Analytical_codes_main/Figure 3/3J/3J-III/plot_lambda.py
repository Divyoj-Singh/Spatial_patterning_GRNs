...
x, y = np.loadtxt('TSSA_tristable_lambdau3_1D.dat', unpack=True, usecols=[0,1])
...
x, y = np.loadtxt('TSSA_tristable_lambdau3_1D.dat', unpack=True, usecols=[0,2])

plt.plot(x, y, color='blue', linestyle='solid', linewidth = 4, marker='o', markerfacecolor='blue', markeredgecolor="navy", markersize=12)

x, y = np.loadtxt('TSSA_tristable_lambdau3_2D.dat', unpack=True, usecols=[0,1])
...
plt.text(10.2, -0.115,'$\lambda_p$', color='blue')
plt.text(10.2, -0.195,'$\lambda_m$', color='blue')
plt.text(10.2, -0.215,'$\lambda_p$', color='brown')
plt.text(10.2, -0.298,'$\lambda_m$', color='brown')

plt.savefig('TSSA_tri_lambda.png', dpi=300)
