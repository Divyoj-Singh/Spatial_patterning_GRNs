...
x, y = np.loadtxt('TSSA_tristable_lambda_1D.dat', unpack=True, usecols=[0,1])
...
x, y = np.loadtxt('TSSA_tristable_lambda_1D.dat', unpack=True, usecols=[0,2])

plt.plot(x, y, color='blue', linestyle='solid', linewidth = 4, marker='o', markerfacecolor='blue', markeredgecolor="navy", markersize=12)

x, y = np.loadtxt('TSSA_tristable_lambda_2D.dat', unpack=True, usecols=[0,1])
...
plt.text(10.2, -0.18,'$\lambda_p$', color='blue')
plt.text(10.2, -0.225,'$\lambda_m$', color='blue')
plt.text(10.2, -0.275,'$\lambda_p$', color='brown')
plt.text(10.2, -0.32,'$\lambda_m$', color='brown')
