...
x, y = np.loadtxt('TSSA_tri_trace_1D.dat', unpack=True, usecols=[0,1])
...
x, y = np.loadtxt('TSSA_tri_trace_2D.dat', unpack=True, usecols=[0,1])
...
x, y = np.loadtxt('TSSA_tri_trace_0D.dat', unpack=True, usecols=[0,1])
...
plt.ylabel('Trace', fontsize=18, weight='bold')
...
plt.savefig('TSSA_tri_trace.png', dpi=300)
